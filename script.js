...
const createNewTaskElement=function(taskString){
    ...
    listItem.classList.add('block-tasks__itemns');
    //input (checkbox)
    ...
    label.className='block-tasks__item';
...
const editTask = function(){
    ...
    //If class of the parent is .block-tasks__itemns
    if(containsClass){

        //switch to .block-tasks__itemns
    ...
    //toggle .block-tasks__itemns on the parent.
